...
//	private BigDecimal userMobile;
	...
	public HdkUser( BigDecimal idUser,String userName, String userPwd, String userMail, String usertoken) {
		this.idUser = idUser;
...
//	}
	...
	public String toString() {
		return "HdkUser [idUser=" + idUser + ", userName=" + userName + ", userPwd=" + userPwd + ", userMail="
				+ userMail + ", usertoken=" + usertoken + "]";
	}
